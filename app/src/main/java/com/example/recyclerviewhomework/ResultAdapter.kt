...
class ResultAdapter(private val list: List<Result>, val clickListener: ResultListener) :
...
class ResultListener(val clickListener: (resultId: String, itemPosition: View) -> Unit) {
    fun onClick(result: Result, itemPosition: View) = clickListener(result.id, itemPosition)
}
